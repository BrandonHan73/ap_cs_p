...
public class Config {
    ...
    public static final double ANN_STANDARD_MUTATION_RATE = 0.5, ANN_LOW_MUTATION_RATE = 0.00001,
            ANN_STANDARD_FITNESS_BLOAT_RATE = 2;
    ...
    public static final double BIRD_SPAWN_X = -3.5, BIRD_SPAWN_Y = 0,
            BIRD_SPAWN_X_RANDOM = 0, BIRD_SPAWN_Y_RANDOM = 2;

    public static final ImageIcon PIPE_IMAGE_ICON = new ImageIcon("src/config/pipe.png");
    public static final int PIPE_COUNT = 3;
    public static final double PIPE_SPACING, PIPE_OFFSET = 1, PIPE_VARIATION = 2, PIPE_SPEED = 3;
    ...
    private static long SPEED_MULTIPLIER = 1;
    public static void setSpeedMultiplier(long speedMultiplier) {

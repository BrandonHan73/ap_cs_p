...
public class Config {
    ...
    public static final double UNITS_PER_PIPE;
    public static final double PIPE_OFFSET = 1, PIPE_VARIATION = 5;
    ...
    static {
        ...
        UNITS_PER_PIPE = (WINDOW_WIDTH_UNITS + (2 * PIPE_OFFSET)) / PIPE_COUNT;
    }
